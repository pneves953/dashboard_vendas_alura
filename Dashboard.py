...
# colocando como padrão da pagina como wide
...
with aba3:
    qtd_vendedores=st.number_input('Quantidade de vendas por vendedores',2,10,5)
    coluna1, coluna2 = st.columns(2)
    with coluna1:
        st.metric("Receita Total",formata_numero(dados['Preço'].sum(),"R$"))
